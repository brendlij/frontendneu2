    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin" element={<AdminView />}>
          ...
          <Route
            path="/admin/add-study-program"
            element={<AddStudyProgram />}
          />
          ...
          <Route
            path="/admin/edit-studyclass/:id"
            element={<EditStudyClass />}
          />
          <Route path="/admin/edit-lecturer/:id" element={<EditLecturer />} />
          <Route
            path="/admin/edit-lecturedate/:id"
            element={<EditLectureDate />}
          />
          <Route
            path="/admin/edit-study-program/:id"
            element={<EditStudyProgram />}
          />
          <Route
            path="/admin/lecturer-dashboard"
